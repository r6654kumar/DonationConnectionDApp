...
const Card = ({ allCampaigns, setOpenModel, setDonateCampaign, title }) => {
  ...
  return (
    <>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-xl-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">

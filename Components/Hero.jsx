...
const Hero = ({ titleData, createCampaign }) => {
  ...
  return (
    <div className="relative">
      ...
      <img src="https://images.pexels.com/photos/3228766/pexels-photo-3228766.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=2&amp;h=750&amp;w=1260" alt=""
          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm: text-5xl sm:leading-none">
                Decentralized Crowdfunding Platform<br className="hidden md:block"></br></h2>
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                Create and contribute to fundraising campaigns for various causes and projects in a secure and transparent way.<br></br>
                Donation Connection  supports seamless integration with popular cryptocurrency wallets like MetaMask for secure transactions.</p>
              <a href="/"
                aria-label=""
                className="inline-flex items-center font-semibold tracking-wider transition-colors duration-200 text-teal-accent-400 
                ...
                <form>
                  <div className="mb-1 sm:mb-2">
                    <label htmlFor="firstName"
                      className="inline-block mb-1 font-medium">Title</label>
                    <input onChange={(e) =>
                      setCampaign({
                        ...campaign,
                  ...
                  <div className="mb-1 sm:mb-2">
                    <label htmlFor="date"
                      className="inline-block mb-1 font-medium">Deadline</label>
                    <input onChange={(e) =>
                      setCampaign({
                        ...campaign,
                  ...
                  <div className="mb-1 sm:mb-2">
                    ...
                    rounded shadow-md bg-deep-purple-accent-400 hovering:bg-deep-purple-accent-700 
                    focus:shadow-outline focus:outline-none newColor"
                    >Create Campaign</button>
                  </div>
                  <p className="text-xs text-gray-600 sm:text-sm">
                    Create your Campaign and raise fund in a secure way.
